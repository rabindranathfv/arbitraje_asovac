    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arbitraje', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='arbitrajes.Arbitraje')),
            ],
        ),
        migrations.CreateModel(
            name='Trabajo',
            fields=[
                ...
                ('resumen', models.TextField(default='', max_length=255)),
                ...
                ('archivo_trabajo', models.FileField(upload_to=trabajos.models.job_directory_path)),
