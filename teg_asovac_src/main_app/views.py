...
def verify_configuracion_general_option(estado, rol_id, item_active): 
    if (1 in rol_id and item_active == 1) or (2 in rol_id and item_active == 1):
        return 1
    return 0
...
def verify_crear_trabajo_option(estado,rol_id):
...
def validate_rol_status(estado,rol_id,item_active):
    ...
    crear_trabajo_sidebar = verify_crear_trabajo_option(estado,rol_id)
    ...
    #Menú de trabajos
    items.setdefault("crear_trabajo_sidebar",[crear_trabajo_sidebar,reverse('trabajos:trabajos')])
