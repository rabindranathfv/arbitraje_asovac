    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institucion_trabajo', models.CharField(blank=True, max_length=50)),
                ('datos_institucion', models.CharField(blank=True, max_length=100)),
                ('areas_interes', models.CharField(blank=True, max_length=50)),
                ('observaciones', models.TextField(blank=True, max_length=100)),
