...
class Arbitro(models.Model):
	...
	institucion_trabajo = models.CharField(max_length=254,blank=True)
	datos_institucion = models.CharField(max_length=254,blank=True)
	areas_interes = models.CharField(max_length=254,blank=True)
	observaciones = models.TextField(max_length=254, blank = True)
