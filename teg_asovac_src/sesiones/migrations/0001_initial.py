    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arbitraje_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='arbitrajes.Arbitraje')),
                ('espacio_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='sesiones.Espacio')),
            ],
        ),
        migrations.AddField(
            model_name='espacio',
            name='espacio_fisico_id',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='sesiones.Espacio_fisico'),
        ),
        migrations.AddField(
            model_name='espacio',
            name='espacio_virtual_id',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='sesiones.Espacio_virtual'),
        ),
    ]
