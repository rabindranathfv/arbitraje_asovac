    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('constancia_estudio', models.FileField(blank=True, upload_to='constancias_de_estudio/')),
                ...
                ('nivel_instruccion', models.CharField(choices=[('Educaci\xf3n B\xe1sica Primaria', 'Educaci\xf3n B\xe1sica Primaria'), ('Educaci\xf3n B\xe1sica Secundaria', 'Educaci\xf3n B\xe1sica Secundaria'), ('Bachillerato/Educaci\xf3n Media', 'Bachillerato/Educaci\xf3n Media'), ('Educaci\xf3n T\xe9cnico/Profesional', 'Educaci\xf3n T\xe9cnico/Profesional'), ('Universidad', 'Universidad'), ('Postgrado', 'Postgrado')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorias_pago', models.CharField(choices=[('P', 'Personal'), ('I', 'Institutos profesionales'), ('T', 'Terceros'), ('U', 'Universidades')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_pago', models.CharField(choices=[('T', 'Transferencia'), ('C', 'Cheque')], max_length=1)),
